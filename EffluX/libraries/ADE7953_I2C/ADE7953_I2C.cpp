...
uint8_t ADE7953::getVersion(){
  return i2cAlgorithm8_read(functionBitVal(Version_8,1), functionBitVal(Version_8,1));  //An example of the address lookup - the spiAlgorithm8_read((functionBitVal(addr,1), functionBitVal(addr,1)) would return the eqivenet to spiAlgorithm8_read(0x07,0x02) when working properly
}

float ADE7953::getPowerFactorA(){  
	int16_t value=0;  
	value=i2cAlgorithm16_read((functionBitVal(PFA_16,1)),(functionBitVal(PFA_16,1))); 
...
int16_t ADE7953::getPhaseCalibA(){  
	int16_t value=0;  
	value=i2cAlgorithm16_read((functionBitVal(PHCALA_16,1)),(functionBitVal(PHCALA_16,1))); 
  return value;
...
float ADE7953::getPeriod(){  
	uint16_t value=0;  
	value=i2cAlgorithm16_read((functionBitVal(Period_16,1)),(functionBitVal(Period_16,1))); 
...
unsigned long ADE7953::getAPNOLOAD(){  //use signed long for signed registers, and unsigned long for unsigned registers
	...
	value=i2cAlgorithm32_read((functionBitVal(AP_NOLOAD_32,1)),(functionBitVal(AP_NOLOAD_32,1))); //Call MSB and LSB from the register constant (template for how all functions should be called)
  return value;
...
long ADE7953::getInstVoltage(){  
	long value=0;  
	value=i2cAlgorithm32_read((functionBitVal(V_32,1)),(functionBitVal(V_32,1)));
  return value;
...
float ADE7953::getVrms(){  
	...
	value=i2cAlgorithm32_read((functionBitVal(VRMS_32,1)),(functionBitVal(VRMS_32,1)));
	float decimal = decimalize(value, 19090, 1);
  return decimal;
...
long ADE7953::getInstCurrentA(){  
	long value=0;  
	value=i2cAlgorithm32_read((functionBitVal(IA_32,1)),(functionBitVal(IA_32,1))); 
  return value;
...
float ADE7953::getIrmsA(){  
	unsigned long value=0;  
	value=i2cAlgorithm32_read((functionBitVal(IRMSA_32,1)),(functionBitVal(IRMSA_32,1))); 
	float decimal = decimalize(value, 1327, 1);
  return decimal;
...
unsigned long ADE7953::getVpeak(){  
	unsigned long value=0;  
	value=i2cAlgorithm32_read((functionBitVal(VPEAK_32,1)),(functionBitVal(VPEAK_32,1))); 
  return value;
...
unsigned long ADE7953::getIpeakA(){  
	unsigned long value=0;  
	value=i2cAlgorithm32_read((functionBitVal(IAPEAK_32,1)),(functionBitVal(IAPEAK_32,1))); 
  return value;
...
long ADE7953::getActiveEnergyA(){  
	long value=0; 
	value=i2cAlgorithm32_read((functionBitVal(AENERGYA_32,1)),(functionBitVal(AENERGYA_32,1))); 
  return value;
...
long ADE7953::getReactiveEnergyA(){  
	long value=0;  
	value=i2cAlgorithm32_read((functionBitVal(RENERGYA_32,1)),(functionBitVal(RENERGYA_32,1))); 
  return value;
...
long ADE7953::getApparentEnergyA(){ 
	long value=0;  
	value=i2cAlgorithm32_read((functionBitVal(APENERGYA_32,1)),(functionBitVal(APENERGYA_32,1))); 
  return value;
...
float ADE7953::getInstApparentPowerA(){  
	long value=0;  
	value=i2cAlgorithm32_read((functionBitVal(AVA_32,1)),(functionBitVal(AVA_32,1))); 
...
float ADE7953::getInstActivePowerA(){  
	long value=0;  
	value=i2cAlgorithm32_read((functionBitVal(AWATT_32,1)),(functionBitVal(AWATT_32,1))); 
	float decimal = decimalize(value, 1.502, 0);
  return abs(decimal);
...
float ADE7953::getInstReactivePowerA(){  
	long value=0;  
	value=i2cAlgorithm32_read((functionBitVal(AVAR_32,1)),(functionBitVal(AVAR_32,1))); 
	float decimal = decimalize(value, 1.502, 0);
  return decimal;
...
void ADE7953::initialize(){
  ...
  //Calibrations
  i2cAlgorithm16_write((functionBitVal(PHCALA_16,1)),(functionBitVal(PHCALA_16,1)),0x00,0x00);  //This may need to be turned off if there are issues!
  delay(100);
  ...
  delay(100);
  i2cAlgorithm8_write((functionBitVal(LCYCMODE_8,1)),(functionBitVal(LCYCMODE_8,1)),0b01111111); //Enable line cycle accumulation mode for all energies and channels
  delay(100);
  i2cAlgorithm16_write((functionBitVal(LINECYC_16,1)),(functionBitVal(LINECYC_16,1)),0x00,0x78); //Sets number of half line cycle accumulations to 120
  delay(100);
  Wire.endTransmission();
}
//**************************************************
